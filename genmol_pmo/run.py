...
def main():
    ...
    try:
        ...
        # PyTDC jnk3 pickle is incompatible with newer scikit-learn tree dtype.
        if args.oracle == "jnk3" and "incompatible dtype" in str(exc):
            raise RuntimeError(
                "jnk3 oracle failed due to scikit-learn model compatibility. "
                "Please use scikit-learn==1.2.2 in the genmol environment."
            ) from exc
        raise
