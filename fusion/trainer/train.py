...
CUDA_VISIBLE_DEVICES=2 python fusion/trainer/train.py \
--dataset data/zinc250k \
--output_dir f-RAG/outpot_dir \
...
class FusionTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs_tuple, return_outputs=False, num_items_in_batch=None):
