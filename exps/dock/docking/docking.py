...
class DockingVina(object):
    def __init__(self, target):
        ...
        # resolve paths relative to this file; allow overriding qvina binary via env
        base_dir = os.path.dirname(__file__)
        default_qvina = os.path.join(base_dir, "qvina02")
        self.vina_program = os.environ.get("QVINA_BIN", default_qvina)
